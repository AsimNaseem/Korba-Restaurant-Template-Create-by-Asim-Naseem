      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {[
            ...
            <div key={feature.title} className={`bento-card group p-0 overflow-hidden relative ${feature.highlight ? 'bg-brand border-none' : 'hover:border-brand-yellow/50'}`}>
    ...
    <section id="menu" className="py-32 px-6 bg-zinc-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-8 h-[1000px] md:h-[700px]">
          <div className="md:col-span-2 md:row-span-2 bento-card p-0 overflow-hidden relative group">
            <img 
  ...
  const posts = [
    {
      ...
      date: "Feb 15, 2026",
      image: "https://picsum.photos/seed/pulao-blog/800/600",
    ...
    },
    {
      ...
      date: "Feb 08, 2026",
      image: "https://picsum.photos/seed/spices-blog/800/600",
    ...
    },
    {
      ...
      date: "Jan 28, 2026",
      image: "https://picsum.photos/seed/chai-blog/800/600",
      category: "Beverages"
    },
    {
      id: 4,
      ...
      author: "Sarah Green",
      date: "Jan 15, 2026",
      image: "https://picsum.photos/seed/farm-blog/800/600",
    ...
    },
    {
      ...
      author: "Chef Ahmed Khan",
      date: "Jan 02, 2026",
      image: "https://picsum.photos/seed/chapli-blog/800/600",
          ...
          {posts.map((post, i) => (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="text-brand font-bold text-xs flex items-center gap-1">
